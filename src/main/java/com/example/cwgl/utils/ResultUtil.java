...
public class ResultUtil {
    ...
    public static Result success2(String msg, Object object){
        Result result = new Result();
        result.setCode(Config.SUCCESS_2);
        result.setMsg(msg);
        result.setData(object);
        return result;
    }

    public static Result success3(String msg, Object object){
        Result result = new Result();
        result.setCode(Config.SUCCESS_3);
        result.setMsg(msg);
        result.setData(object);
        return result;
    }
